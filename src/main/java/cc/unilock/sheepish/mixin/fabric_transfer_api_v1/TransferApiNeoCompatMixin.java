...
public class TransferApiNeoCompatMixin {
	...
	private static Object wrapProviderSafely(Object original, @Local(argsOnly = true) BlockEntity blockEntity) {
		...
		return (Boolean) original && "minecraft".equals(namespace);
	}
}
